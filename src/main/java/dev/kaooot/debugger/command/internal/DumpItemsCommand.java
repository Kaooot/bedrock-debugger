 ...
 */
@Name("dumpitems")
@Description("Outputs valid item nbt in a binary format.")
@Overloads({
...
public class DumpItemsCommand extends DumpPaletteCommand {

    @Override
    public void execute(String command, String[] args, BedrockDebuggerProxy proxy) {
        this.execute0(args, "item_palette", proxy.getPlayer().getItemList(), proxy);
    }
}