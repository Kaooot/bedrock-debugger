 ...
 * @author Kaooot
 */
@Name("dumpvoxelshapes")
@Description("Outputs valid voxel shapes nbt in a binary format.")
@Overloads({
...
public class DumpVoxelShapesCommand extends DumpPaletteCommand {

    @Override
    public void execute(String command, String[] args, BedrockDebuggerProxy proxy) {
        this.execute0(args, "voxel_shapes", proxy.getPlayer().getVoxelShapes(), proxy);
    }
}