 ...
 */
@Name("dumpentities")
@Description("Outputs valid entity nbt in a binary format.")
@Overloads({
...
public class DumpEntitiesCommand extends DumpPaletteCommand {

    @Override
    public void execute(String command, String[] args, BedrockDebuggerProxy proxy) {
        this.execute0(args, "entity_identifiers", proxy.getPlayer().getActorInfoList(), proxy);
    }
}