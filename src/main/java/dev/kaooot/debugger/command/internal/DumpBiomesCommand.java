 ...
 */
@Name("dumpbiomes")
@Description("Outputs valid biome nbt in a binary format.")
@Overloads({
...
public class DumpBiomesCommand extends DumpPaletteCommand {

    @Override
    public void execute(String command, String[] args, BedrockDebuggerProxy proxy) {
        this.execute0(args, "biome_definitions", proxy.getPlayer().getBiomeData(), proxy);
    }
}